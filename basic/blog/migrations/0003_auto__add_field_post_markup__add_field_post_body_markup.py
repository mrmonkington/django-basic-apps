...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_posts', 'markup', self.gf('django_markup.fields.MarkupField')(default='markdown', max_length=255), keep_default=False)

        # Adding field 'Post.body_markup'
        db.add_column('blog_posts', 'body_markup', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.markup'
        db.delete_column('blog_posts', 'markup')

        # Deleting field 'Post.body_markup'
        db.delete_column('blog_posts', 'body_markup')
